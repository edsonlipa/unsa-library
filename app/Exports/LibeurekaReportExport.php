...
class LibeurekaReportExport implements FromCollection,WithHeadings
{
    /**
    ...
    */
    ...
    {
        $account_legis = LibeurekaAccess::select('first_name', 'last_name', 'email', 'created_on', 'updated_on')->get();
