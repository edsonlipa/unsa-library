...
class McgrawhillReportExport implements FromCollection,WithHeadings
{
    /**
    ...
    */
    ...
    {
        $account_legis = McgrawhillAccess::select('first_name', 'last_name', 'email', 'created_on', 'updated_on')->get();
