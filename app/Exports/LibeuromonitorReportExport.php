...
class LibeuromonitorReportExport implements FromCollection,WithHeadings
{
    /**
    ...
    */
    ...
    {
        $account_legis = LibeuromonitorAccess::select('first_name', 'last_name', 'email', 'created_on', 'updated_on')->get();
